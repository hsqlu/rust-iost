...
struct NameVisitor<T: FromStr<Err = ParseNameError> + From<u64> + core::fmt::Display>(
...
macro_rules! declare_name_types {
    ($($ident:ident)*) => ($(
        #[derive(Debug, PartialEq, Eq, Clone, Copy, Default, Hash, PartialOrd, Ord, Read, Write, NumberBytes, Encode, Decode)]
